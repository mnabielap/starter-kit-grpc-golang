...
const (
	...
	AuthService_ForgotPassword_FullMethodName        = "/v1.AuthService/ForgotPassword"
	AuthService_ResetPassword_FullMethodName         = "/v1.AuthService/ResetPassword"
	AuthService_SendVerificationEmail_FullMethodName = "/v1.AuthService/SendVerificationEmail"
	AuthService_VerifyEmail_FullMethodName           = "/v1.AuthService/VerifyEmail"
)
...
type AuthServiceClient interface {
	...
	SendVerificationEmail(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SuccessResponse, error)
...
func (c *authServiceClient) SendVerificationEmail(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuccessResponse)
...
type AuthServiceServer interface {
	...
	// Send Verification Email (Authenticated user)
	SendVerificationEmail(context.Context, *Empty) (*SuccessResponse, error)
	// Verify Email (Use token from email)
...
func (UnimplementedAuthServiceServer) SendVerificationEmail(context.Context, *Empty) (*SuccessResponse, error) {
...
func _AuthService_SendVerificationEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SendVerificationEmail(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
